...
export function login(email, password, navigate) {
  return async (dispatch) => {
    ...
    try {
      ...
      // Log full response and check user data
      ...
      // Dispatch token and save it in localStorage
      dispatch(setToken(token));
      // localStorage.setItem("token", token);

      // Prepare user image and dispatch user data
    ...
    // Stop loading and dismiss toast
    dispatch(setLoading(false));
    // toast.dismiss(toastId);
  };
}
...
export function resetPassword(password, confirmPassword, token, navigate) {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("RESETPASSWORD ERROR DETAILS............", error.response ? error.response.data : error.message);
      toast.error("Failed To Reset Password");
    }
